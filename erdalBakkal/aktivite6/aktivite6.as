package  { /// yapılacaklar, etiket uretme, etiketi urune yapistirma, o urun oldugunu kontrol etme, cetveli duzeltme,
	...
	public class aktivite6 extends MovieClip {	
		...
		var A_Increase:Number = 20;
		var A_Increase2:Number = 20;
		var A_Increased:Number = 0;
		var A_Denominator:Number = 100;
		// ikinci urun
		var B_Money:Number = 100; 
		var B_Increase:Number = 20;
		var B_Increase2:Number = 20;
		...
		public function aktivite6(){
			// constructor code
			hesapMc_iki_mc.x=350;
			hesapMc_iki_mc.y=410;
			hesapMc_bir_mc.x=350;
			hesapMc_bir_mc.y=410;
		...
		public function hesapla(e:MouseEvent):void{
			...
			var ruler:Ruler= getChildByName("ruler") as Ruler;
			...
			if (currentObjectName == "A"){
				if(hesapMc_bir_mc.indirimFiyat_txt.text==(A_Money/A_Denominator)*A_Increase){
					if(hesapMc_bir_mc.indirimliFiyat_txt.text==A_Money-((A_Money/A_Denominator)*A_Increase)){
						...
						ruler.animalWeight_txt.text=rulerDenominator.toString();
						hesap=true;
			...
			{	
				...
				{	
					...
					{ 
						...
						feed_3_mc.tamam_etiket_btn.addEventListener(MouseEvent.CLICK, kaldir);
		...
		public function textboxTemixle():void{
			hesapMc_bir_mc.eskiFiyat_txt="";
			hesapMc_bir_mc.indirimFiyat_txt"";
			hesapMc_bir_mc.indirimliFiyat_txt""; 
		} 
