package  { 
	...
	public class aktivite7 extends MovieClip {
		...
		public function aktivite7() {
			// constructor code
			
			hesapMc_iki_mc.x=400;
			hesapMc_iki_mc.y=450;
			hesapMc_bir_mc.x=400;
			hesapMc_bir_mc.y=450;
			...
			if (object is meyve_suyu_urun)
			{
				...
				{ 
					if(!hesap){
						...
						hesapMc_bir_mc.eskiFiyat_txt.text=rulerDenominator.toString();
					}
				}
